...
apollo_control = list(modelName ="ICLV_3_LC_CONTROL_BELIEFS",
                      modelDescr ="ICLV 3 LC WITH CONTROL BELIEFS",
                      indivID ="ID",
                      mixing =TRUE,
                      nCores =4)
...
startvalues=c(startvalues,
              rep(0,12),                      # taus for the latent class model
...
apollo_lcPars=function(apollo_beta, apollo_inputs){
  ...
  V=list()
  V[["class_C1"]] = 0
  V[["class_C2"]] = int_C2 + tau_SOCIALBARS_C2*SOCIALBARS+tau_FEARSURGERY_C2*FEARSURGERY+tau_PRIVACY_C2*PRIVACY+tau_TRAVELCOST_C2*TRAVELCOST+tau_REASSURANCE_C2*REASSURANCE
  V[["class_C3"]] = int_C3 + tau_SOCIALBARS_C3*SOCIALBARS+tau_FEARSURGERY_C3*FEARSURGERY+tau_PRIVACY_C3*PRIVACY+tau_TRAVELCOST_C3*TRAVELCOST+tau_REASSURANCE_C3*REASSURANCE
